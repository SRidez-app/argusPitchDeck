  ...
  const phases = [
    {
      ...
      story: "We had conversations with dozens of insurance customers. Implementation resources were limited and they only wanted data for disputed claims. Then came the Lyft Insurance Meeting - The Breakthrough.",
    ...
    },
    {
      ...
      story: "The team went full-time in June, we're on the mission. Changed the passive detection model to real-time inference model. This required building the most advanced tagging and traffic detection system ever. We automatically retrain every two weeks based on our 3 success criteria. Moved video archives business to PLG to support existing business and reduce resources demand.",
    ...
    },
    {
      ...
      story: "Marketing started September 15th. DOTs/ITS partnerships: MDOT, NDOT, FDOT, Saudi Arabia. Mobility integrations: Werner, DoorDash, Bringg.com, Sygic. October 1st - moved into Insurance/PI Firms.",
      icon: <Target size={40} color="#FFCA2B" strokeWidth={2.5} />,
      milestones: [
        '15 PI Firms Joined - 200 searches',
        'Top 20 Insurance Discussions',
      ...
      >
        ...
        >
          {currentPhase < phases.length - 1 
            ? '→ Press arrow key for next phase' 
